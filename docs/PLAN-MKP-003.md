...
**Review history**: Prior Codex and Claude review findings were incorporated into this plan, including tooling addition and successful protoc check on 2026-07-03. Standalone review artifacts have been removed. Successor: docs/PLAN-MKP-003-Release.md (the PLAN-MKP-002-Release.md is legacy stub).
